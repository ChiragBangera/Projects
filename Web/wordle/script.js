...
const diffMilli = Date.now() - startDate
const days = diffMilli / 1000 / 3600 / 24
const targetWord = target[Math.floor(days)]
...
// detect key and display it
function pressKey(key) {
    const activeTiles = getActive()
